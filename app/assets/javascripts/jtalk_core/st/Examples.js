...
smalltalk.addClass('Todos', smalltalk.Widget, [], 'Examples');
smalltalk.addMethod(
'_renderOn_',
smalltalk.method({
selector: 'renderOn:',
...
fn: function (html){
var self=this;
(function($rec){smalltalk.send($rec, "_id_", ["views"]);return smalltalk.send($rec, "_with_", [(function(){return (function($rec){smalltalk.send($rec, "_id_", ["tasks"]);return smalltalk.send($rec, "_with_", [(function(){smalltalk.send(smalltalk.send(html, "_h1", []), "_with_", ["Todos"]);smalltalk.send(self, "_renderFormOn_", [html]);smalltalk.send(smalltalk.send(html, "_div", []), "_class_", ["items"]);return smalltalk.send(self, "_renderFooterOn_", [html]);})]);})(smalltalk.send(html, "_div", []));})]);})(smalltalk.send(html, "_div", []));
return self;},
source: unescape('renderOn%3A%20html%0A%09html%20div%20id%3A%20%27views%27%3B%20with%3A%20%5B%0A%09%09html%20div%20id%3A%20%27tasks%27%3B%20with%3A%20%5B%0A%09%09%09html%20h1%20with%3A%20%27Todos%27.%0A%09%09%09self%20renderFormOn%3A%20html.%0A%09%09%09html%20div%20class%3A%20%27items%27.%0A%09%09%09self%20renderFooterOn%3A%20html%5D%5D'),
messageSends: ["id:", "with:", "h1", "renderFormOn:", "class:", "div", "renderFooterOn:"],
referencedClasses: []
}),
smalltalk.Todos);
...
fn: function (html){
var self=this;
(function($rec){smalltalk.send($rec, "_with_", [(function(){return (function($rec){smalltalk.send($rec, "_at_put_", ["type", "text"]);return smalltalk.send($rec, "_at_put_", ["placeholder", unescape("What%20needs%20to%20be%20done%3F")]);})(smalltalk.send(html, "_input", []));})]);return smalltalk.send($rec, "_onSubmit_", [(function(){return alert('hi');})]);})(smalltalk.send(html, "_form", []));
return self;},
source: unescape('renderFormOn%3A%20html%0A%09html%20form%0A%09%09with%3A%20%5B%0A%09%09%09html%20input%0A%09%09%09%09at%3A%20%27type%27%20put%3A%20%27text%27%3B%0A%09%09%09%09at%3A%20%27placeholder%27%20put%3A%20%27What%20needs%20to%20be%20done%3F%27%20%5D%3B%0A%09%09onSubmit%3A%20%5B%20%3Calert%28%27hi%27%29%3E%20%5D'),
messageSends: ["with:", "at:put:", "input", "onSubmit:", "form"],
referencedClasses: []
}),
smalltalk.Todos);
...
fn: function (html){
var self=this;
smalltalk.send(smalltalk.send(html, "_footer", []), "_with_", [(function(){(function($rec){smalltalk.send($rec, "_class_", ["clear"]);return smalltalk.send($rec, "_with_", ["Clear completed"]);})(smalltalk.send(html, "_a", []));return (function($rec){smalltalk.send($rec, "_class_", ["count"]);smalltalk.send($rec, "_with_", [(function(){return smalltalk.send(smalltalk.send(html, "_span", []), "_class_", ["countVal"]);})]);return smalltalk.send($rec, "_append_", [" left"]);})(smalltalk.send(html, "_div", []));})]);
return self;},
source: unescape('renderFooterOn%3A%20html%0A%09html%20footer%20with%3A%20%5B%0A%09%09html%20a%20class%3A%20%27clear%27%3B%20with%3A%20%27Clear%20completed%27.%0A%09%09html%20div%0A%09%09%09class%3A%20%27count%27%3B%0A%09%09%09with%3A%20%5Bhtml%20span%20class%3A%20%27countVal%27%5D%3B%0A%09%09%09append%3A%20%27%20left%27%5D'),
messageSends: ["with:", "footer", "class:", "a", "span", "append:", "div"],
referencedClasses: []
}),
smalltalk.Todos);
...
'_renderDefault',
smalltalk.method({
selector: 'renderDefault',
category: 'not yet classified',
fn: function (){
var self=this;
smalltalk.send(smalltalk.send(unescape("%23todos-app"), "_asJQuery", []), "_append_", [smalltalk.send(self, "_new", [])]);
return self;},
source: unescape('renderDefault%0A%0A%09%27%23todos-app%27%20asJQuery%20append%3A%20self%20new'),
messageSends: ["append:", "asJQuery", "new"],
referencedClasses: []
}),
smalltalk.Todos.klass);
